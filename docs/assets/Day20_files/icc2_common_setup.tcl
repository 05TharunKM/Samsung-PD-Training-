...
set REFERENCE_LIBRARY 		[list sky130_v5_7magic.lef avsddac.lef avsdpll.lef]	;# Required; a list of reference libraries for the design library.
...
set VERILOG_NETLIST_FILES	"vsdbabysoc_gtlvl.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TECH_FILE 			"sky130_fd_sc_hd.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
					;# TECH_FILE is recommended, although TECH_LIB is also supported in ICC2 RM. 
set TECH_LIB			"sky130_fd_sc_hd__tt_025C_1v80.lib"	;# Specify the reference library to be used as a dedicated technology library;
...
set LINK_LIBRARY		[list avsddac.db  avsdpll.db sky130_fd_sc_hd__tt_025C_1v80.db]	;# Specify .db files;
